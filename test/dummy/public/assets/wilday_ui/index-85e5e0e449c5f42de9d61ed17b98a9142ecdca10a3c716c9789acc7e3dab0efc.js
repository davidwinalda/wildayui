...
var dropdown_controller_default = class extends Controller {
  ...
  updatePosition() {
    ...
    console.log("Setting position:", position, "align:", align);
    this.menuTarget.removeAttribute("style");
    this.menuTarget.classList.remove(
      "w-button-dropdown-menu-start",
      "w-button-dropdown-menu-end",
      "w-button-dropdown-menu-center"
    );
    this.menuTarget.classList.add(`w-button-dropdown-menu-${align}`);
    console.log("Classes set:", this.menuTarget.className);
  }
  get isOpen() {
